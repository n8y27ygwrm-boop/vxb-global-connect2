...
export const categories: Category[] = [
  {
    ...
    options: [
      {
        optionId: "option-1",
        name: "Home Use 16A 32A Adjustable Electric Car Charger 7KW 11KW Type 2 CEE Plug Portable EV Charger",
        supplier: "TARY / OEM",
        modelNumber: "PEV-Q-LJ1",
        description:
          "Portable home-use EV charger with adjustable 16A and 32A output, supporting Type 2, GBT, and Type 1 interface variants for flexible charging setups.",
        highlights: [
        ...
        specs: [
          "Output Power: 3.5-11kW",
          "Output Current: AC16A / AC32A",
          "Input Voltage: 200-220V / 380V",
          "Interface Standard: Type2 / GBT / Type1",
          "Wire Length: 5M (customizable)",
          "Current: 16A / 32A",
          "Application: Fast Charge",
          "Condition: New",
          "Warranty: 1 Year",
          "Model Number: PEV-Q-LJ1",
          "Origin: Anhui, China",
          "Gross Weight: 5 kg",
          "Package Size: 30 x 30 x 40 cm",
        ],
